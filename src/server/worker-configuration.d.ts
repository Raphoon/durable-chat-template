/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/server/worker-configuration.d.ts` (hash: 5d9304788dba18a06a1441f44522a912)
// Runtime types generated with workerd@1.20260219.0 2025-10-08 
declare namespace Cloudflare {
	interface Env {
		ASSETS: Fetcher;
		Chat: DurableObjectNamespace /* Chat */;
		RoomRegistry: DurableObjectNamespace /* RoomRegistry */;
	}
}
